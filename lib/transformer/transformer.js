...
var parseExcelRecords = function (records, region){
    var accounts, columns, row, schema,  errorAccounts;
    accounts = [];
    errorAccounts = [];
    ...
    for (row in records) {        
        ...
        var errors = loopColumns(account,errorAccount,columns,schema);
...
var loopColumns = function(account,errorAccount,columns,schema){
    var jsonPath,element,column,data,_k, _len2,error,errors;
